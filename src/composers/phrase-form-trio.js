...
var tempo = random(45,180)
Transport.bpm.value = tempo

function duo(){
    var degree=notes[count]
    var pitch=scale[degree+7]+reg
    var pitch2=0

    piano.noteon(pitch+key)
    ...
    if (notesOn[count]===1){
        ...
        piano.noteon(scale[notesB[count]]+36+key)
        piano.noteon(scale[notesB[count]+9]+36+key)
        piano.noteon(scale[notesB[count]+4]+36+key)
    }
    //outlet(2,count)
var og
var ogB
